...
namespace Wrappers
{
    ...
    bool MBaseSession::ValidateMediaFile(System::String __gc* value)
    {
        char* pAnsiString = (char*)(void*)Marshal::StringToHGlobalAnsi(value);
        bool retVal = m_pBASE_SESSION->validateMediaFile(pAnsiString);
        Marshal::FreeHGlobal(pAnsiString);
        return retVal;
    }
        ...
        System::String __gc* sessionFileName)
    {
        ...
        bool retVal = m_pBASE_SESSION->save(pAnsiString);
        Marshal::FreeHGlobal(pAnsiString);
        return retVal;
    }
    */
        ...
        System::String __gc* pFileName)
    {
        ...
        FILE_DATASET_CLASS* pFileDataSet = m_pBASE_SESSION->readMedia(pAnsiStringFileName, true, true);
        pDicomFile = 
    ...
    {
        // TODO: Expose only at MScriptSession. This method should be moved!
