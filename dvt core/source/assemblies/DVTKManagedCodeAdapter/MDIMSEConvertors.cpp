...
namespace ManagedUnManagedDimseConvertors
{
        ...
        //<<===========================================================================
    {
		...
		// get length
		pAttribute->Length = pUMAttribute->getPaddedLength();
        ...
        pAttribute->DicomValue = Convert(pUMAttribute->GetVR(), pUMAttribute->GetValueList());
    ...
    DvtkData::Dimse::DicomValueType __gc* 
        ManagedUnManagedDimseConvertor::Convert(ATTR_VR_ENUM vr, VALUE_LIST_CLASS *pUMValueList)
        ...
        case ATTR_VR_OB:
            {
                ...
                if (pUMValueList)
                {
                    if (pUMValueList->GetNrValues() == 1)
                    {
                        BASE_VALUE_CLASS *pUMOtherValue = pUMValueList->GetValue(0);
                        ...
                        else
                        {
                            ...
                            for (int i = 0; i < 7; i++)
                            {
                                ...
                                case 2: pBitmapPattern->StartValue = (System::Int16) value; break;
                                case 3: pBitmapPattern->ValueIncrementPerRowBlock = (System::Int16) value; break;
                                case 4: pBitmapPattern->ValueIncrementPerColumnBlock = (System::Int16) value; break;
