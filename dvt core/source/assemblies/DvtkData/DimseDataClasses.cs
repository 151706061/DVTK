...
namespace DvtkData.Dimse
{
    ...
    public abstract class AttributeSet : DvtkData.Collections.NullSafeCollectionBase, IDvtDetailToXml
    {
		...
		public void ConsoleDisplay()
		{
			...
			{
				string group = attribute.Tag.GroupNumber.ToString("X");
				while (group.Length < 4)
				{
					group = "0" + group;
				}
				string element = attribute.Tag.ElementNumber.ToString("X");
				while (element.Length < 4)
				{
					element = "0" + element;
				}

				Console.Write("({0},{1}), {2}, {3:00000000}", group, element, attribute.ValueRepresentation.ToString(), attribute.Length);
				if (attribute.Length != 0)
				{
					switch(attribute.ValueRepresentation)
					{
						...
						case VR.SQ:
						{
							...
							{
								Console.WriteLine("> Begin Item: {0}", itemNumber);
								item.ConsoleDisplay();
								Console.WriteLine("> End Item: {0}", itemNumber++);
							}
							break;
						}
						case VR.SS:
						...
						case VR.US:
						{
							...
							Console.WriteLine(", \"{0}\"", unsignedShort.Values[0]);
							break;
						}
						case VR.UT:
						{
...
//                    else if (item is System.UInt32) tag = (System.UInt32)item;
		...
		public bool DvtDetailToXml(StreamWriter streamWriter, int level)
		{
			...
			streamWriter.WriteLine("<Attribute Group=\"{0}\" Element=\"{1}\" VR=\"{2}\" Name=\"{3}\">", group, element, ValueRepresentation.ToString(), DvtToXml.ConvertString(Name));
    ...
    public class UniqueIdentifier : DicomValueType 
    {
        ...
        private const System.String _DvtUidRoot = "100.118.116.2004.2.0";
        /// <summary>
    ...
    public class BitmapPatternParameters
    {
        ...
        /// Start value.
        /// </summary>
        public System.Int16    StartValue = 0;
        /// <summary>
        /// Value increment per row block.
        /// </summary>
        public System.Int16    ValueIncrementPerRowBlock = 1;
        /// <summary>
        /// Value increment per column block.
        /// </summary>
        public System.Int16    ValueIncrementPerColumnBlock = 1;
        /// <summary>
        ...
        public BitmapPatternParameters(
            ...
            System.Int16 startValue,
            System.Int16 valueIncrementPerRowBlock,
            System.Int16 valueIncrementPerColumnBlock,
...
//        }
    ...
    public class Unknown : DicomValueType 
    {
        ...
        private /*System.Byte[]*/ ArrayList _ByteArray = null;
        // TODO should this be new ArrayList()?
