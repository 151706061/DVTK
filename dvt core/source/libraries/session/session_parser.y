...
%token T_CIPHER_LIST T_CACHE_TLS_SESSIONS T_TLS_CACHE_TIMEOUT T_CREDENTIALS_FILENAME T_CERTIFICATE_FILENAME 
%token T_VAL_RES T_DIMSE_MSG T_ACSE_MSG T_PDU_DUMP T_LABEL_DUMP T_IMAGE_SAVE T_STORAGE_MODE
%token T_DEF_SQ_LENGTH T_ADD_GROUP_LENGTH T_SUPPORTED_TRANSFER_SYNTAX T_FORMAT T_STRICT T_DATA_DIRECTORY
...
%token TRUE_OR_FALSE INTEGER STRING LOG_LEVEL SESSION_TYPE STORAGE_MODE SUT_ROLE
...
%token T_DETAILED_RESULTS T_SUMMARY_RESULTS T_INCLUDE_TYPE3_NOTPRESENT
