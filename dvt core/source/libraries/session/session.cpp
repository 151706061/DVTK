...
//<<===========================================================================
{
    ...
    installCharacterSetAndImageDisplayFormatData();
...
FILE_DATASET_CLASS* BASE_SESSION_CLASS::readMedia(string fileName, bool useSessionStorageMode, bool logIt)
...
void BASE_SESSION_CLASS::installCharacterSetAndImageDisplayFormatData()
