...
//<<===========================================================================
{
	...
	introducerLengthM = UNDEFINED_LENGTH;
...
//<<===========================================================================
{
	// count the length od the Item Introducer
...
//<<===========================================================================
{
    ...
    introducerLengthM = sourceItem.introducerLengthM;
...
//<<===========================================================================
{
    ...
    introducerLengthM = copyItem->introducerLengthM;
