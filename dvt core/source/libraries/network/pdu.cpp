...
bool PDU_CLASS::write(BASE_SOCKET_CLASS *socket_ptr)

//  DESCRIPTION     : Write PDU to socket.
//  PRECONDITIONS   : 
//  POSTCONDITIONS  : 
//  EXCEPTIONS      : 
//  NOTES           :
//<<===========================================================================
{
	if (socket_ptr == NULL) return false;

	// write the pdu header
	if (!(*socket_ptr << pduTypeM)) return false;
	if (!(*socket_ptr << reservedM)) return false;
	if (!(*socket_ptr << lengthM)) return false;

	// write the pdu body
	return socket_ptr->writeBinary(bodyM_ptr, lengthM);
}

//>>===========================================================================

bool PDU_CLASS::readType(BASE_SOCKET_CLASS *socket_ptr)

//  DESCRIPTION     : Read PDU Type from socket.
//  PRECONDITIONS   : 
//  POSTCONDITIONS  : 
//  EXCEPTIONS      : 
//  NOTES           :
//<<===========================================================================
{
	...
	// read the item type
	return (*socket_ptr >> pduTypeM);
}

//>>===========================================================================

bool PDU_CLASS::readBody(BASE_SOCKET_CLASS *socket_ptr)

//  DESCRIPTION     : Read PDU Body from socket.
//  PRECONDITIONS   : 
//  POSTCONDITIONS  : 
//  EXCEPTIONS      : 
//  NOTES           :
//<<===========================================================================
{
	...
	if (bodyM_ptr)
	{
		...
		while (bytesToRead) 
		{
			// read as many bytes from socket as possible
			INT bytesRead = socket_ptr->readBinary(&bodyM_ptr[offsetM], bytesToRead);
