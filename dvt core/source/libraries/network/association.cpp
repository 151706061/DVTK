...
bool ASSOCIATION_CLASS::releaseAssocation()
...
RECEIVE_MSG_ENUM ASSOCIATION_CLASS::receiveDataset(DCM_DATASET_CLASS **dataset_ptr_ptr, bool dimseOnly, AE_SESSION_CLASS*)
...
//<<===========================================================================
{
	...
	*dataset_ptr_ptr = NULL;
	...
	if (dataSetType != NO_DATA_SET)
	{
		...
		if ((status = receiveDataset(dataset_ptr_ptr, dimseOnly, ae_session_ptr)) != RECEIVE_MSG_SUCCESSFUL)
		{
...
//<<===========================================================================
{
	...
	// check if presentation context id provided by in DICOMScript
