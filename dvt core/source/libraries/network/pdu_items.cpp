...
//<<===========================================================================
{
	...
	for (i = 0; i < sopClassExtendedM.getSize(); i++) 
	{
	...
	while (remainingLength > 0)
	{
		...
		switch(itemType)
		{
			...
			default: // unknown item type
				{
					// skip ovre the unknown sub-item
					BYTE reserved;
					UINT16 length;
...
//<<===========================================================================
{
	...
	for (i = 0; i < userInformation.sopClassExtendedM.getSize(); i++)
	{
...
//<<===========================================================================
{
	...
	// - sop class extended
	for (i = 0; i < updateUserInformation.noSopClassExtendeds(); i++)
	{
		// set the value straight away
