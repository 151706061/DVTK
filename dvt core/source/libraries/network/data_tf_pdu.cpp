...
bool DATA_TF_PDU_CLASS::readBody(BASE_SOCKET_CLASS *socket_ptr)

//  DESCRIPTION     : Read P-DATA-TF PDU Body from socket.
//  PRECONDITIONS   : 
//  POSTCONDITIONS  : 
//  EXCEPTIONS      : 
//  NOTES           :
//<<===========================================================================
{
	...
	if (!PDU_CLASS::readBody(socket_ptr)) return false;
