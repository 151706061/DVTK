...
//<<===========================================================================		
{
	...
	{
		result4 = transferSyntaxNameM.validate((char*) srcPC_ptr->getTransferSyntaxName().get(), refTransferSyntaxName);
        transferSyntaxNameM.setMeaning(transferSyntaxUidToName((char*) srcPC_ptr->getTransferSyntaxName().get()));
	}
