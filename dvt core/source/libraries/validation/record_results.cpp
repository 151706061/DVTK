...
void RECORD_RESULTS_CLASS::Validate(string rootDirLocation)
...
//<<===========================================================================
{
    ...
    if (referenceFileM != "")
    {
        referencedFile = CheckFileExistance(referenceFileM);
    }
...
//<<===========================================================================
{
    ...
    else
    {
        ...
        validator_ptr->ValidateRefFile(fileDatasetM_ptr, this, refDataset_ptr, validationFlag, aeSession_ptr);
