...
//<<===========================================================================
{
    ...
    if (status)
    {
        validator_ptr->SetModuleResultsFromDcm(command_ptr, true);
        if (refCommand_ptr != NULL)
		{
            validator_ptr->SetModuleResultsFromDcm(refCommand_ptr, false);
		}
...
//<<===========================================================================
{
    ...
    if (status)
    {
        validator_ptr->SetModuleResultsFromDcm(dataset_ptr, true);
        if (refDataset_ptr != NULL)
		{
            validator_ptr->SetModuleResultsFromDcm(refDataset_ptr, false);
		}
...
void VALIDATION_ENGINE_CLASS::setLastReqDataset(DCM_DATASET_CLASS *dataset_ptr)

//  DESCRIPTION     : Set the last request dataset.
//  PRECONDITIONS   :
//  POSTCONDITIONS  :
//  EXCEPTIONS      : 
//  NOTES           :
//<<===========================================================================
{
    lastReqDatasetM_ptr = dataset_ptr;
}
...
//<<===========================================================================
{
	...
	else
    {
		...
		else if (sopClassUid == PATIENT_ROOT_QR_FIND_SOP_CLASS_UID ||
				 sopClassUid == PATIENT_ROOT_QR_MOVE_SOP_CLASS_UID ||
				 sopClassUid == PATIENT_ROOT_QR_GET_SOP_CLASS_UID ||
				 sopClassUid == STUDY_ROOT_QR_FIND_SOP_CLASS_UID ||
				 sopClassUid == STUDY_ROOT_QR_MOVE_SOP_CLASS_UID ||
				 sopClassUid == STUDY_ROOT_QR_GET_SOP_CLASS_UID ||
				 sopClassUid == PATIENT_STUDY_ONLY_QR_FIND_SOP_CLASS_UID ||
				 sopClassUid == PATIENT_STUDY_ONLY_QR_MOVE_SOP_CLASS_UID ||
				 sopClassUid == PATIENT_STUDY_ONLY_QR_GET_SOP_CLASS_UID ||
                 sopClassUid == MODALITY_WORKLIST_FIND_SOP_CLASS)
        {
