...
bool PRINT_SCP_EMULATOR_CLASS::addSupportedPresentationContexts()
...
bool PRINT_SCP_EMULATOR_CLASS::processAction()
...
//<<===========================================================================
{
	...
	// return the response
	return sendResponse(DIMSE_CMD_NACTION_RSP, status, response_ptr);
}

//>>===========================================================================

bool PRINT_SCP_EMULATOR_CLASS::processCreate(DCM_DATASET_CLASS *dataset_ptr)
...
//<<===========================================================================
{
	...
	// return response
	return sendResponse(DIMSE_CMD_NCREATE_RSP, status, response_ptr);
}

//>>===========================================================================

bool PRINT_SCP_EMULATOR_CLASS::processDelete()
...
//<<===========================================================================
{
	...
	// return response
	return sendResponse(DIMSE_CMD_NDELETE_RSP, status);
}
...
//<<===========================================================================
{
	...
	// return response
	return sendResponse(DIMSE_CMD_NGET_RSP, status, response_ptr);
}

//>>===========================================================================

bool PRINT_SCP_EMULATOR_CLASS::processSet(DCM_DATASET_CLASS *dataset_ptr)
