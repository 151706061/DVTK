...
namespace DvtkApplicationLayer {
    ...
    public abstract class Session {
        ...
        protected DvtkSession.Session implementation = null;
        protected string sessionFileName;
        protected string sutVersion = "";
        protected bool isLoaded = false;
        protected string baseLocation;
        protected bool result = false;
        protected ArrayList summaryFiles = new ArrayList();
        protected ArrayList detailFiles = new ArrayList();
        protected string resultsRootDirectory;
        protected string definitionRootDirectory = @"C:\Program Files\DVT\definitions";
        protected string sessionFile = "";
        protected DateTime date = DateTime.Today;
        protected string sessionTitle = "";
        public UInt16 sessionId = 0;
        protected string softwareVersions = "2.1.001";
        protected string testedBy = "DVT";
        protected string manufacturer = "DVT";
        protected string modelname = "DVT";
        protected Boolean   autoCreateDirectory = true;
        protected Boolean continueOnError = true ;
        protected StorageMode storageMode = StorageMode.AsMedia;
        protected int logLevelFlagsMask = (int)LogLevelFlags.Error;
        protected IList results = new ArrayList();
        protected UInt16 nrOfErrors;
        protected UInt16 nrOfWarnings ;
        protected bool optionVerbose = false ;
        protected bool detailedValidationResults=true;
        private bool isExecuting = false;
        protected bool backUpResults = true ;
        protected string dataDirectory ;
        public DvtkSession.Session tempSession ;
        public bool hasSessionchanged = false ;
        private Project parentProject  = null;
        public SecuritySettings securitySettings = new SecuritySettings();
...
/// </summary>
       ...
       /// </summary>
        ...
        /// <summary>
        /// Proerty that set & get the LogLevelFlags for a session.
        /// </summary>
