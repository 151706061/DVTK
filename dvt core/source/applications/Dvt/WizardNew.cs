...
namespace Dvt
{
    ...
    public class WizardNew : System.Windows.Forms.Form
    {
        ...
        public void ConstructAndSaveProject(Project theProject)
        {
			theProject.display_message = new Dvt.Project.CallBackMessageDisplay (this.CallBackMessageDisplay);
        ...
        {
            /*
            Dvtk.Sessions.SecuritySettings      security_settings;

            if (this.ComboBoxSessionType.SelectedIndex != 1)
            {
                // Page 6
                // Page 7
                // Page 8
                security_settings.CheckRemoteCertificate = this.CheckBoxCheckRemoteCertificates.Checked;
                security_settings.CacheTlsSessions =    this.CheckBoxCacheSecureSessions.Checked;
                if (this.CheckBoxTLS.Checked)
                {
                    security_settings.TlsVersionFlags = Dvtk.Sessions.TlsVersionFlags.TLS_VERSION_TLSv1;
                    if (this.CheckBoxSSL.Checked)
                        security_settings.TlsVersionFlags |= Dvtk.Sessions.TlsVersionFlags.TLS_VERSION_SSLv3;
                }
                else
                    security_settings.TlsVersionFlags = Dvtk.Sessions.TlsVersionFlags.TLS_VERSION_SSLv3;
            }
        ...
        private     Dvtk.Sessions.Session   session;

        /*
                private bool CheckTCPIPAddress ()
                {
                    bool status = true;
                    if (this.RadioButtonSpecify.Checked == true)
                    {
                        int nr_elements = 0;
                        int nr_digits = 0;
                        int element = 0;
                        for (int index=0 ; index<this.TextBoxTCPIP.Text.Length ; index++)
                        {
                            if (this.TextBoxTCPIP.Text[index] == '.')
                            {
                                if ((nr_digits > 0) && (element < 256))
                                {
                                    nr_elements++;
                                    nr_digits=0;
                                    element=0;
                            ...
                            else
                            {
                                ...
                                element = element*10 + this.TextBoxTCPIP.Text[index] - '0';
                                nr_digits++;
                            }
                        }
                        // Check final digit.
                    ...
                    if (!status)
                        MessageBox.Show (this,
                            "TCP/IP address is not a correct format.\nUse xxx.xxx.xxx.xxx\nWith xxx being values between 0 and 255.",
                            "Invalid TCP/IP",
        ...
        */
        ...
        private void InitializeComponent()
        {
			...
			this.label32.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			// Page5
			// 
			//this.Page5.Controls.Add(this.DateSession);
			...
			// DateSession
			// 
//			this.DateSession.Location = new System.Drawing.Point(144, 160);
//			this.DateSession.Name = "DateSession";
//			this.DateSession.Size = new System.Drawing.Size(248, 20);
//			this.DateSession.TabIndex = 4;
			// 
			// TextBoxUserName
			// 
...
//			this.label13.Text = "Date:";
			...
			// NumericDVTPDULength
			// 
			this.NumericDVTPDULength.Increment = new System.Decimal(new int[] {
																				  256,
																				  0,
																				  0,
																				  0});
			this.NumericDVTPDULength.Location = new System.Drawing.Point(264, 144);
			this.NumericDVTPDULength.Maximum = new System.Decimal(new int[] {
																				1048576,
																				0,
																				0,
																				0});
			...
			// 
			this.NumericSocketTimeOut.Increment = new System.Decimal(new int[] {
																				   10,
																				   0,
																				   0,
																				   0});
			this.NumericSocketTimeOut.Location = new System.Drawing.Point(264, 112);
			this.NumericSocketTimeOut.Maximum = new System.Decimal(new int[] {
																				 1000,
																				 0,
																				 0,
																				 0});
			...
			this.NumericSocketTimeOut.Value = new System.Decimal(new int[] {
																			   90,
																			   0,
																			   0,
																			   0});
			...
			this.NumericDVTListenPort.Value = new System.Decimal(new int[] {
																			   104,
																			   0,
																			   0,
																			   0});
			...
			this.NumericSUTListenPort.Value = new System.Decimal(new int[] {
																			   104,
																			   0,
																			   0,
																			   0});
			...
			this.label21.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			// NumericSUTPDULength
			// 
			this.NumericSUTPDULength.Increment = new System.Decimal(new int[] {
																				  256,
																				  0,
																				  0,
																				  0});
			this.NumericSUTPDULength.Location = new System.Drawing.Point(264, 112);
			this.NumericSUTPDULength.Maximum = new System.Decimal(new int[] {
																				1048576,
																				0,
																				0,
																				0});
			...
			this.label26.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.label33.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.label37.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
			...
			this.label30.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(0)));
        ...
        private void UpdateAENameVersionBox ()
        {
            foreach (string filename in this.ListBoxDefinitionFiles.Items)
            {
                ...
                try
                {
                    def_details = this.session.DefinitionManagement.GetDefinitionFileDetails (filename);
        ...
        {
            if (this.ComboBoxSessionType.SelectedIndex == 0) // script session
                (session as Dvtk.Sessions.ISecure).SecuritySettings.CheckRemoteCertificate = this.CheckBoxCheckRemoteCertificates.Checked;
            else    // emulator session
                (session as Dvtk.Sessions.ISecure).SecuritySettings.CheckRemoteCertificate = this.CheckBoxCheckRemoteCertificates.Checked;
        }
        ...
        {
            if (this.ComboBoxSessionType.SelectedIndex == 0) // script session
                (session as Dvtk.Sessions.ISecure).SecuritySettings.CacheTlsSessions = this.CheckBoxCacheSecureSessions.Checked;
            else    // emulator session
                (session as Dvtk.Sessions.ISecure).SecuritySettings.CacheTlsSessions = this.CheckBoxCacheSecureSessions.Checked;
        }
