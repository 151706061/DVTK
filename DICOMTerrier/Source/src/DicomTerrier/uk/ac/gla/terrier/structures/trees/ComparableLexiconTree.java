 ...
 * formed by the terms in the comparable lexicon.
 * @author Gerald van Veldhuijsen
 * @version Version 1.0
 */
public class ComparableLexiconTree extends LexiconTree {
	...
	*/
	...
	/**
	 * Inserts a new term in the comparable lexicon binary tree.
	 ...
	 */
	protected void traverseAndStoreToBuffer(ComparableDICOMFieldDocumentTreeNode node) throws IOException {
		if (node != null) {
