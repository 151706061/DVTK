...
/**
 * This class implements an input stream for the comparable lexicon structure.
 * @author Gerald Veldhuijsen
 */
public class ComparableLexiconInputStream {
	 ...
	 */
	public ComparableLexiconInputStream() {
		try {
			lexiconStream =
				new DataInputStream(
	 ...
	 */
	public ComparableLexiconInputStream(String filename) {
		try {
			lexiconStream =
				new DataInputStream(
	 ...
	 */
	public ComparableLexiconInputStream(File file) {
		try {
			lexiconStream =
				new DataInputStream(
	...
	public int readNextEntry() throws IOException {
		try {
			...
			startOffset = lexiconStream.readLong();
			startBitOffset = lexiconStream.readByte();
	...
	public void print() {
		int i = 0; //counter
		int entryLength = ComparableLexicon.lexiconEntryLength;
		try {
