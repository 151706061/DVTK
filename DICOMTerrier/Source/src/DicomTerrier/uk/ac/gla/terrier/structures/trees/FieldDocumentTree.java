...
public class FieldDocumentTree {
	...
	*/
	...
	public void insert(String newTerm) {
		if (treeRoot==null) {
			treeRoot = new FieldDocumentTreeNode(newTerm);
			numberOfNodes++;
			numberOfPointers++;			
		} else {
			...
			while (true) {
				...
				if (lexicographicOrder == 0) {
					...
					if (tmpNode.left==null) {
						tmpNode.left = new FieldDocumentTreeNode(newTerm);
						numberOfNodes++;
						numberOfPointers++;
						break;
					} else 
					...
					if (tmpNode.right==null) {
						tmpNode.right = new FieldDocumentTreeNode(newTerm);
						numberOfNodes++;
						numberOfPointers++;						
						break;
					} else 
	...
	public void insert(String newTerm, String field) {
		if (treeRoot==null) {
			treeRoot = new FieldDocumentTreeNode(newTerm, field);
			numberOfNodes++;
			numberOfPointers++;			
		} else {
			FieldDocumentTreeNode tmpNode = treeRoot;
			while (true) {
				...
				if (lexicographicOrder == 0) {
					...
					if (tmpNode.left==null) {
						tmpNode.left = new FieldDocumentTreeNode(newTerm,field);
						numberOfNodes++;
						numberOfPointers++;
						break;
					} else 
					...
					if (tmpNode.right==null) {
						tmpNode.right = new FieldDocumentTreeNode(newTerm,field);
						numberOfNodes++;
						numberOfPointers++;						
						break;
					} else 
	...
	public void insert(String newTerm, HashSet fields) {
		if (treeRoot==null) {
			treeRoot = new FieldDocumentTreeNode(newTerm, fields);
			numberOfNodes++;
			numberOfPointers++;			
		} else {
			FieldDocumentTreeNode tmpNode = treeRoot;
			while (true) {
				...
				if (lexicographicOrder == 0) {
					...
					if (tmpNode.left==null) {
						tmpNode.left = new FieldDocumentTreeNode(newTerm, fields);
						numberOfNodes++;
						numberOfPointers++;
						break;
					} else 
					...
					if (tmpNode.right==null) {
						tmpNode.right = new FieldDocumentTreeNode(newTerm, fields);
						numberOfNodes++;
						numberOfPointers++;						
						break;
					} else 
