...
function newwindow(){
	if(fullimagepath){
		...
		windownew = window.open('','jav','scrollbars=1, width=' + (width+ 40) + ',height=' + (height+50) + ',resizable=yes');
...
{
  if (
     document.submitform.check0.checked  == false ||
     document.submitform.check1.checked  == false ||
     document.submitform.check2.checked  == false ||
     document.submitform.check3.checked  == false ||
     document.submitform.check4.checked  == false ||
     document.submitform.check5.checked  == false ||
     document.submitform.check6.checked  == false ||
     document.submitform.check7.checked  == false ||
     document.submitform.check8.checked  == false ||
     document.submitform.check9.checked  == false
  ) {
